...
namespace Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        public void AddComment(string content, string username)
        {
            ...
            {
                throw new InvalidOperationException($"The value of {nameof(content)} cannot be null or empty. " +
                    $"Please provide a valid {nameof(content)}!");
            }
        ...
        {
            _id = @event.Id;
            _comments.Add(@event.CommentId, new Tuple<string, string>(@event.Content, @event.Username));
        }

        public void EditComment(Guid commentId, string content, string username)
        {
            if (!_active)
            {
        ...
        {
            _id = @event.Id;
            _comments[@event.CommentId] = new Tuple<string, string>(@event.Content, @event.Username);
        }
